...
VERSION_RSVG=dc0c0548 # https://gitlab.gnome.org/GNOME/librsvg/-/merge_requests/967
VERSION_AOM=3.8.2
VERSION_HEIF=1.17.6
VERSION_CGIF=0.4.0
...
mkdir ${DEPS}/rsvg
$CURL https://gitlab.gnome.org/kleisauke/librsvg/-/archive/${VERSION_RSVG}/librsvg-${VERSION_RSVG}.tar.gz | tar xzC ${DEPS}/rsvg --strip-components=1
cd ${DEPS}/rsvg
# https://gitlab.gnome.org/GNOME/librsvg/-/merge_requests/966
$CURL https://gitlab.gnome.org/GNOME/librsvg/-/merge_requests/966.patch | patch -p1
